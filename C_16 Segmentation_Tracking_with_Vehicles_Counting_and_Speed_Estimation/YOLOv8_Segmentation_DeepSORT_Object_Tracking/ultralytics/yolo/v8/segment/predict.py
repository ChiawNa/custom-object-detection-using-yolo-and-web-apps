...
def draw_boxes(img, bbox, names,object_id, identities=None, offset=(0, 0)):
    ...
    for i, box in enumerate(bbox):
        ...
        for idx, (key, value) in enumerate(object_counter1.items()):
            ...
            cv2.putText(img, f'Count  of Vehicles Entering', (width - 500, 35), 0, 1, [225,0, 0], thickness=2, lineType=cv2.LINE_AA)

            ###
            cv2.putText(img, "Total Count: "+str(count_up), (width - 300, 75), 0, 1, [225, 0, 0], thickness=2, lineType=cv2.LINE_AA)
        ...
        for idx, (key, value) in enumerate(object_counter.items()):
            ...
            cv2.putText(img, f'Count of Vehicles Leaving', (11, 35), 0, 1, [225, 0, 0], thickness=2, lineType=cv2.LINE_AA)
            ###
            cv2.putText(img,  "Total Count: "+str(count_down), (11, 75), 0, 1, [225, 0, 0], thickness=2, lineType=cv2.LINE_AA)

            ###
            #cv2.line(img, (20,95+ (idx*40)), (127,95+ (idx*40)), [85,45,255], 30)
            
            cv2.putText(img, cnt_str1, (11, 105+ (idx*40)), 0, 1, [225, 0, 0], thickness=2, lineType=cv2.LINE_AA)
